...
class RandomCrop(object):
    ...
    def __call__(self, image, lane=None, fs=None):
        ...
        scaleW = np.random.randint(-self.scale*image_width, self.scale*image_width)
        scaleH = np.random.randint(-self.scale*image_height, self.scale*image_height)
...
class SSDAugmentation(object):
    def __init__(self, h=480, w=640, mean=(104, 117, 123)):
        self.mean = mean
        self.h = h
        self.w = w
